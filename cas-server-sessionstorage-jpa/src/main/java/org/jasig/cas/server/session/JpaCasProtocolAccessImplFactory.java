...
public final class JpaCasProtocolAccessImplFactory extends AbstractCasProtocolAccessImplFactory {
    ...
    public void initialize() {
        JpaCasProtocolAccessImpl.setProxyHandler(getProxyHandler());
        JpaCasProtocolAccessImpl.setServiceIdentifierMatcher(getServiceIdentifierMatcher());
        JpaCasProtocolAccessImpl.setExpirationPolicy(getExpirationPolicy());
        JpaCasProtocolAccessImpl.setUniqueTicketIdGenerator(getUniqueTicketIdGenerator());
    }
}
