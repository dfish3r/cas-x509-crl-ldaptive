...
public interface SessionStorage {
     ...
     *
     * @param authenticationResponse the successful authentication response that will be used to construct this session.
     * @return the fully constructed session.  This should never return null.
     */
    Session createSession(AuthenticationResponse authenticationResponse);
