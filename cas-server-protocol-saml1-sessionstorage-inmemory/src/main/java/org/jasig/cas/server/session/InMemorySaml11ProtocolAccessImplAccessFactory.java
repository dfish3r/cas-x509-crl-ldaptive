...
public final class InMemorySaml11ProtocolAccessImplAccessFactory extends AbstractSaml1ProtocolAccessImplFactory {
    ...
    public Access getAccess(final Session session, final ServiceAccessRequest serviceAccessRequest) {
        ...
        return new InMemorySaml11ProtocolAccessImpl(impl.getProfile(), getUniqueTicketIdGenerator().getNewTicketId(""), serviceAccessRequest.getServiceId(), getEncoding(), getServiceIdentifierMatcher(), getIssuer(), getIssueLength(), session);
    }
}
