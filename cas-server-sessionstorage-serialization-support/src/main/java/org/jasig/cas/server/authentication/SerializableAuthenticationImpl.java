 ...
 * @since 3.5
 */
public final class SerializableAuthenticationImpl extends AbstractAuthenticationImpl {
    ...
    public SerializableAuthenticationImpl(final Map<String, List<Object>> authenticationMetaData, final boolean longTermAuthentication, final String authenticationMethod) {
    ...
    public boolean equals(Object o) {
        ...
        SerializableAuthenticationImpl that = (SerializableAuthenticationImpl) o;

        if (longTermAuthentication != that.longTermAuthentication) return false;
        if (authenticationDate != null ? !authenticationDate.equals(that.authenticationDate) : that.authenticationDate != null)
            return false;
