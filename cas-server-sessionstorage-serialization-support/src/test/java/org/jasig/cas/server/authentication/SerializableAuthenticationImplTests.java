 ...
 * @since 4.0.0
 */
public class SerializableAuthenticationImplTests extends AbstractAuthenticationTests {

    private SerializableAuthenticationFactoryImpl impl = new SerializableAuthenticationFactoryImpl();
