 ...
 * @since 3.5
 */
public final class InMemoryAuthenticationImpl extends AbstractAuthenticationImpl {
    ...
    public InMemoryAuthenticationImpl(final Map<String, List<Object>> authenticationMetaData, final boolean longTermAuthentication, final String authenticationMethod) {
