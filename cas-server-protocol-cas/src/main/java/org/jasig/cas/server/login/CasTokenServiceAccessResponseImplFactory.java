...
/**
 * Returns instances of {@link CasTokenServiceAccessResponseImpl}.
 *
...
public final class CasTokenServiceAccessResponseImplFactory implements ServiceAccessResponseFactory {
    ...
    public ServiceAccessResponse getServiceAccessResponse(final ServiceAccessRequest serviceAccessRequest) {
        return new CasTokenServiceAccessResponseImpl((TokenServiceAccessRequest) serviceAccessRequest);
    }
    ...
    public ServiceAccessResponse getServiceAccessResponse(final Session session, final Access access, final AuthenticationResponse authenticationResponse, final List<Access> loggedOutAccesses) {
        return new CasTokenServiceAccessResponseImpl(access);
    }

    public boolean supports(final ServiceAccessRequest serviceAccessRequest) {
        return serviceAccessRequest instanceof CasTokenServiceAccessRequestImpl;
    }
