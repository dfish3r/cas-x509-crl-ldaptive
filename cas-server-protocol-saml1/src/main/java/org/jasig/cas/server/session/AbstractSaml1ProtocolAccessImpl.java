...
public abstract class AbstractSaml1ProtocolAccessImpl implements Access {
    ...
    protected enum ValidationStatus {NOT_VALIDATED, SUCCEEDED, USED, ALREADY_VALIDATED}
    ...
    private Response generateSuccessResponse() {
        ...
        final SAMLObjectBuilder<Subject> subjectSAMLObjectBuilder = (SAMLObjectBuilder<Subject>) builderFactory.getBuilder(Subject.DEFAULT_ELEMENT_NAME);
        ...
        final SAMLObjectBuilder<Conditions> conditionsSAMLObjectBuilder = (SAMLObjectBuilder<Conditions>) builderFactory.getBuilder(Conditions.DEFAULT_ELEMENT_NAME);
...
//        status.setStatusDetail(statusDetail);
        ...
        assertion.setConditions(conditionsSAMLObjectBuilder.buildObject());
